...
2. Убери то, что НЕ является мемом/шуткой: официальные скриншоты без шутки, арт, серьёзные
   обсуждения, новостные картинки, утечки без юмористического контекста. Также убери
   NSFW/откровенный контент, оскорбительные или разжигающие ненависть картинки, треш-контент
   и провокации не по теме игры — часть постов приходит из менее модерируемого сабреддита,
   отбирай только то, что действительно безопасно показать широкой аудитории.
