...
2. Убери то, что НЕ является мемом/шуткой: официальные скриншоты без шутки, арт, серьёзные
   обсуждения, новостные картинки, утечки без юмористического контекста, спекуляции без
   шутки. Также убери NSFW/откровенный контент, оскорбительные или разжигающие ненависть
   картинки. Оценивай КАЖДЫЙ пост отдельно по его содержанию — то, что пост пришёл из
   сабреддита r/GTA6unmoderated, само по себе не повод его исключать, там тоже попадаются
   нормальные смешные мемы наравне с чем-то не по теме.
